...
public class IOHiveStockage {
    ...
    private static final String HIVE_URL = "jdbc:hive2://cluster-node-cztqntk4f5x6-e5kbhg3sdc2o-v47yamcxijkc:10000/groupe_six";
    ...
    public void createTable(String tableName, List<String> columns) throws SQLException {
        ...
        for (int i = 0 ; i < columns.size() ; i++) {
            sqlStatementCreate = sqlStatementCreate + " " +columns.get(i) + "  string,";
        }
